    ...
    <div className="bg-white">
      <section className="bg-slate-900 text-white py-16 text-center p-4">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mt-10 ">
          ...
          <Payment title="Designer Pack" price="$44.99" regularPrice="$99.80" savings="$54.81" mockups="20" color="bg-green-500" savingsColor='text-white' licenseColor="text-white" />
          <Payment title="Agency Pack" price="$84.99" regularPrice="$240.60" savings="$154.61" mockups="50" color="bg-red-500" titleColor="text-white" priceColor="text-white"/>
        </div>
