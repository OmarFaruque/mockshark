    ...
    return (
      <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-white">
        ...
        >
          ...
          <p className="text-gray-500 mb-6 max-w-md">Looks like you haven't added anything to your cart yet</p>
          <Link href="/">
            <motion.button
      ...
      <main className="flex-grow px-4 md:px-6 py-8 max-w-7xl mx-auto w-full">
        ...
        >
          <h1 className="text-3xl font-bold text-gray-800 flex items-center">
            ...
            Your Cart 
            <span className="ml-2 text-cyan-600">({cart.length} {cart.length === 1 ? 'item' : 'items'})</span>
          </h1>
          <Link href="/" className="text-sm text-cyan-600 hover:text-cyan-800 font-medium">
            Continue Shopping →
          </Link>
        </motion.div>
